...
for a given course name and print out its description. The course name should be provided on the command line.

*Hint*: refer to the [scraping-2](scraping-2.qmd) tutorial to get started.
