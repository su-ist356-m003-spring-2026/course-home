...
:::: {.callout-caution appearance="simple" icon="false"}
### Code Challenge 2.1.2: Program to divide up the check among diners in a party
...
:::: {.callout-caution appearance="simple" icon="false"}
### Code Challenge 2.1.3: Presssure sensor that determines whether to open a door
...
:::: {.callout-caution appearance="simple" icon="false"}
### Code Challenge 2.1.4: Number to letter grade
