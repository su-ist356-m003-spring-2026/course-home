...
:::: {.callout-caution appearance="simple" icon="false"}
### Code Challenge 2.5.2

Let's make the code in Challenge 2.5.1 more resusable:
...
:::: {.callout-caution appearance="simple" icon="false"}
### Code Challenge 2.5.3

Let's make the code in Challenge 2.5.2 even more resusable!
...
1.  Create the `dateutils.py` file in VS Code by clicking "File" -> "New File". Name it `dateutils.py`. Then copy the functions you wrote in Challenge 2.5.2 into it (don't forget the `from datetime import datetime` at the top!). Save the file by typing CTRL/CMD + S or clicking File -> Save.
...
:::: {.callout-caution appearance="simple" icon="false"}
### Code Challenge 2.5.4

Write a "round robin" test that tests the `parsedate_mdy` and `formatdate_ymd` functions you wrote in Code Challenge 2.5.3. The test should start with a known input, run the two functions on it, then check if it yields the known output.
